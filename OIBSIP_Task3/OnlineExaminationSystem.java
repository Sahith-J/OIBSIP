...
{  
    ...
    {  
        ...
        {  
            ...
            jb[0].setText("charles Babbage");jb[1].setText("James Ford");jb[2].setText("M.P.Java");jb[3].setText("Blais Pascal");   
        }  
        if(current==1)  
        {  
            l.setText("Que2: What is the number of primitive data types in java?");  
        ...
        if(current==3)  
        {  
            l.setText("Que4: Which component is used to compile, debug and execute the java programs?");  
        ...
        {  
            ...
            jb[0].setText(".js");jb[1].setText(".JVM");jb[2].setText(".JAVA");jb[3].setText(".CLASS");  
        }  
        if(current==5)  
        {  
            l.setText("Que6: What is the extension of compiled java classes?");  
            jb[0].setText(".TEXT");jb[1].setText(".CLASS");jb[2].setText(".JS");jb[3].setText("(All of the above)");  
        }  
        if(current==6)  
        {  
            l.setText("Que7: Which of these are selection statements in Java? ");  
            jb[0].setText("BREAK");jb[1].setText("IFELSE");jb[2].setText("IF");  
                        jb[3].setText("None");  
        }  
        if(current==7)  
        {  
            l.setText("Que8: Which of these keywords is used to define interfaces in Java");  
        ...
        {  
            ...
            jb[0].setText("1 to 256");jb[1].setText(" -128 to 127");jb[2].setText(" 0 to 65535");jb[3].setText("0 to 32767");  
        }  
        if(current==9)  
        {  
